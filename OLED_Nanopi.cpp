...
//Logo BrandMeister 64x16px

const unsigned char logo_dmr_BM [] = {
...
const unsigned char logo_plus_B [] = {
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
...
const unsigned char logo_discon [] = {
...
const unsigned char logo_parrot [] = {
...
const unsigned char logo_sloan [] = {
...
//    OLED_statusbar();
    m_display.drawBitmap(32, 0, logo_sloan,64, 64, WHITE);
    m_display.setTextSize(1);
    m_display.setTextColor(BLACK); 
    m_display.setCursor(34,55);
    m_display.print("by EA5SW");
    m_display.display();
delay (2500);
...
//    m_display.drawBitmap(0, 0, logo_sloan, 64, 64, WHITE);
//    OLED_statusbar();
...
LogInfo ("Temperature is:%d",temp);
      ...
      m_display.setCursor(25,TEMP_LINE);
      m_display.setTextSize(2);
      m_display.printf("Temp:%d",temp);
fclose (temperatureFile);
}

    m_display.setTextSize(1);
    m_display.startscrollleft(0x00,0x0f);  //the MMDVM logo scrolls the whole screen
...
void COLED::writeDMRInt(unsigned int slotNo,const std::string& src,bool group,const std::string& dst,const char* type)
{
    ...
    if ( m_slot1Enabled && m_slot2Enabled ) {
        ...
        if (slotNo == 1U) {
            m_display.fillRect(0,OLED_LINE2,m_display.width(),20,BLACK);
...
void COLED::OLED_statusbar()
{
    ...
    if (m_mode == MODE_DMR){
        m_display.drawBitmap(0, 0, logo_dmr_BM, 64, 16, WHITE);
        m_display.fillRect(0, 14, m_display.width(), 2, BLACK);}
